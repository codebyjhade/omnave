...
import { BookOpen, BrainCircuit, Target, Clock } from "lucide-react";
...
const StatItem = memo(function StatItem({ icon, value, label }: StatItemProps) {
  return (
    <div
      className="bg-[#111111] border border-white/[0.06] border-t-white/[0.12] rounded-3xl p-6 flex flex-col items-center justify-center text-center shadow-lg transition-all duration-500 ease-out hover:bg-[#151515] hover:border-white/[0.15] hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)]"
    >
