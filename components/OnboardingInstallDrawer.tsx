...
export default function OnboardingInstallDrawer() {
  ...
  return (
    <>
      ...
      {/* Bottom Drawer (Same logic as standard PWA drawer) */}
      <div 
        className={`fixed bottom-0 left-0 right-0 z-50 bg-[#0A0A0A] border-t border-white/10 rounded-t-3xl p-6 transition-transform duration-300 ease-out transform ${
