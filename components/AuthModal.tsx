...
export default function AuthModal({ isOpen, onClose, initialView = 'login' }: AuthModalProps) {
  ...
  const handleGoogleLogin = () => {
    toast('Google Sign-In is coming soon! Use email & password for now.', 'info');
  };
                ...
                {authStep === 'signup' || authStep === 'signin' ? (
                  <>
                    ...
                    <button
                      ...
                      className="relative flex w-full items-center justify-center gap-3 rounded-2xl border border-gray-200 bg-white py-3.5 font-semibold text-gray-400 shadow-sm transition-colors opacity-60 cursor-not-allowed"
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-50">
                      ...
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-gray-100 px-2 py-0.5 text-[9px] font-bold uppercase tracking-widest text-gray-400">
                        Soon
                      </span>
                    </button>
