...
export const ExamSetup = React.memo(function ExamSetup({ maxQuestions, onStartExam }: ExamSetupProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto mt-4 animate-in fade-in slide-in-from-bottom-4 duration-500 font-poppins">
      
      {/* Header */}
      <div className="mb-8 text-left">
        <h2 className="text-[10px] font-extrabold tracking-[0.2em] text-gray-400 uppercase mb-2">Summative Assessment</h2>
        <h1 className="text-3xl md:text-5xl font-black tracking-tighter text-gray-900 mb-3">Master Examination</h1>
        <p className="text-sm text-gray-500 max-w-xl font-normal">
      ...
      <div className="bg-white border border-gray-100 rounded-[24px] shadow-[0px_10px_10px_rgba(0,0,0,0.09)] p-6 sm:p-10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-10">
          ...
          {/* Warning Banner */}
          <div className="flex items-start gap-3 bg-amber-50 border border-amber-100 p-5 rounded-[15px] shadow-sm">
            <ShieldAlert className="w-5 h-5 text-amber-600 shrink-0 mt-0.5" />
            <div className="flex flex-col">
              <span className="text-sm font-bold text-amber-700">Endurance Mode Required</span>
              <span className="text-xs text-amber-600/70 font-medium mt-1 leading-relaxed">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Exam Length</h3>
            </div>
                  ...
                  <button
                    ...
                    className={`relative h-14 rounded-2xl border text-sm font-bold transition-all duration-200 overflow-hidden
                      ${isSelected 
                          ...
                          : 'border-gray-200 bg-white text-gray-500 hover:bg-gray-50/50 hover:text-gray-700 cursor-pointer'
                      }
                    `}
                  >
                    {isSelected && <motion.div layoutId="activeExamLength" className="absolute inset-0 bg-amber-500/10" initial={false} transition={{ type: "spring", bounce: 0.2, duration: 0.6 }} />}
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Time Limit</h3>
            </div>
              ...
              {timeOptions.map((mins) => {
                ...
                return (
                  <button
                    ...
                    `}
                  >
                    {isSelected && <motion.div layoutId="activeTimeLimit" className="absolute inset-0 bg-amber-500/10" initial={false} transition={{ type: "spring", bounce: 0.2, duration: 0.6 }} />}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col text-left">
                <span className="text-sm font-bold text-gray-800">Master XP Reward</span>
                <span className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">Maximum Multiplier</span>
              </div>
            </div>
            ...
            <button
              ...
              className="group relative w-full sm:w-auto h-14 px-8 bg-amber-500 hover:bg-amber-400 text-white font-bold border-none rounded-2xl overflow-hidden transition-all duration-200 active:scale-[0.98] focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer shadow-sm"
            >
